  ...
  const branchOptions = useMemo(() => {
    if (isGlobalAdmin) {
      return adminBranches.map((b) => ({
        id: String(b.id),
        label:
          b.organization_name && b.organization_name !== b.fantasy_name
            ? `${b.organization_name} · ${b.fantasy_name?.trim() || b.business_name || String(b.id)}`
            : b.fantasy_name?.trim() || b.business_name || String(b.id),
      }));
    }
                    ...
                    <TabsContent value="endpoints" className="space-y-3 mt-4">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <p className="text-[11px] text-muted-foreground">
                          Rutas relativas a la Base URL. Elige un endpoint para editar su plantilla
                          de body.
                        </p>
                        <button
                          type="button"
                              ...
                              <div className="flex flex-wrap gap-2">
                                <Button
                                  ...
                                  onClick={() => {
                                    ...
                                    setPPayloadTemplates((prev) => ({
                                      ...prev,
                                      [selectedEndpointRow.type]: JSON.stringify(
                                        cfg.payload,
                                        null,
                                        2,
                                      ),
