...
export default function PerfilPage() {
  ...
  const quickLinks = [
    ...
    canAccessBranchesAdmin()
      ...
      : null,
    canAccessUsersAdmin() ? { to: "/admin/usuarios", label: "Usuarios", icon: Users } : null,
    canAccessLlmAdmin() ? { to: "/admin/llm", label: "LLM", icon: ShieldCheck } : null,
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-5 px-4 py-5 md:px-6 lg:px-8">
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1.5 flex flex-wrap gap-1.5">
              ...
              {multiBranch && <Badge variant="outline">Multi-sucursal</Badge>}
