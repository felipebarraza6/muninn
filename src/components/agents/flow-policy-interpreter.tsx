...
function interpretRules(fp: FlowPolicyRaw): Rule[] {
  ...
  // --- v2: availability_requires_professional ---
  ...
  // --- v2: new_patient_intent_patterns ---
  ...
  // --- v2: booking_skill + availability_skills ---
