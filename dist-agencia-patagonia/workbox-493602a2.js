define(["exports"], function (t) {
  ...
  function j(t, e) {
    ...
    const i = async function (t, ...e) {
      ...
      let o = i.store;
      return (n && (o = o.index(e.shift())), (await Promise.all([o[s](...e), r && i.done]))[0]);
    };
    return (W.set(e, i), i);
  }
  N = ((t) =>
  ...
  class A {
    ...
    async expireEntries(t, e) {
      ...
      const o = [];
      for (const t of r) (await s.delete(S, t.id), o.push(t.url));
      return o;
    }
    N(t) {
      return this.I + "|" + K(t);
            ...
            return (
              n &&
                o.addEventListener("upgradeneeded", (t) => {
                  n(B(o.result), t.oldVersion, t.newVersion, B(o.transaction), t);
                }),
              s && o.addEventListener("blocked", (t) => s(t.oldVersion, t.newVersion, t)),
              a
                .then((t) => {
  ...
  class F {
    ...
    async expireEntries() {
      ...
      ((this.k = !1), this.O && ((this.O = !1), b(this.expireEntries())));
    }
    ...
    async K(t, e) {
      ...
      if (!this.j) throw new s("missing-precache-entry", { cacheName: this.cacheName, url: t.url });
      {
        ...
        ((n = await e.fetch(new Request(t, { integrity: "no-cors" !== t.mode ? i || s : void 0 }))),
          s && o && "no-cors" !== t.mode && (this.A(), await e.cachePut(t, n.clone())));
      }
      return n;
    }
    async S(t, e) {
  ...
  ((t.ExpirationPlugin = class {
    constructor(t = {}) {
      ((this.cachedResponseWillBeUsed = async ({
        ...
        const r = this.V(n),
          i = this.J(s);
        b(i.expireEntries());
        const o = i.updateTimestamp(e.url);
        if (t)
          try {
            t.waitUntil(o);
          } catch (t) {}
    ...
    (t.NetworkFirst = class extends v {
      constructor(t = {}) {
        (super(t),
          this.plugins.some((t) => "cacheWillUpdate" in t) || this.plugins.unshift($),
      ...
      async U(t, e) {
        ...
        let i;
        if (this.nt) {
          const { id: s, promise: o } = this.rt({ request: t, logs: n, handler: e });
          ((i = s), r.push(o));
        }
        const o = this.it({ timeoutId: i, request: t, logs: n, handler: e });
        r.push(o);
    ...
    (t.NetworkOnly = class extends v {
      ...
      async U(t, e) {
        ...
        try {
          const s = [e.fetch(t)];
          if (this.nt) {
            const t = u(1e3 * this.nt);
            s.push(t);
          }
          if (((r = await Promise.race(s)), !r))
            throw new Error(`Timed out the network response after ${this.nt} seconds.`);
        } catch (t) {
          t instanceof Error && (n = t);
        }
