import { r as y, j as wt } from "./vendor-react-DUYfdZnL.js";
var I = class {
    constructor() {
...
function tt(t, e) {
  const { type: s = "all", exact: i, fetchStatus: r, predicate: a, queryKey: o, stale: n } = t;
  if (o) {
    if (i) {
      if (e.queryHash !== $(o, e.options)) return !1;
    } else if (!x(e.queryKey, o)) return !1;
  }
  if (s !== "all") {
    const h = e.isActive();
    if ((s === "active" && !h) || (s === "inactive" && h)) return !1;
  }
  return !(
...
function et(t, e) {
  ...
  if (a) {
    ...
    if (s) {
      if (T(e.options.mutationKey) !== T(a)) return !1;
    } else if (!x(e.options.mutationKey, a)) return !1;
  }
  ...
  return t === e
    ...
    : typeof t != typeof e
      ...
      : t && e && typeof t == "object" && typeof e == "object"
        ? Object.keys(e).every((s) => x(t[s], e[s]))
        : !1;
}
...
function ft(t, e, s = 0) {
  ...
  if (s > 500) return e;
  const i = st(t) && st(e);
  if (!i && !(N(t) && N(e))) return e;
  const a = (i ? t : Object.keys(t)).length,
    o = i ? e : Object.keys(e),
    n = o.length,
    h = i ? new Array(n) : {};
  let l = 0;
...
function yt(t) {
  ...
  const r = B(),
    ...
    l = () => V.isFocused() && (t.networkMode === "always" || L.isOnline()) && t.canRun(),
    u = () => pt(t.networkMode) && t.canRun(),
    v = (f) => {
      a() || (i?.(), r.resolve(f));
    },
    c = (f) => {
    ...
    d = () => {
      ...
      Promise.resolve(f)
        ...
        .catch((O) => {
          if (a()) return;
          const C = t.retry ?? (A.isServer() ? 0 : 3),
            P = t.retryDelay ?? qt,
            E = typeof P == "function" ? P(s, O) : P,
            M = C === !0 || (typeof C == "number" && s < C) || (typeof C == "function" && C(s, O));
          if (e || !M) {
            c(O);
            return;
          }
...
var vt = class {
    ...
    updateGcTime(t) {
      this.gcTime = Math.max(this.gcTime || 0, t ?? (A.isServer() ? 1 / 0 : 300 * 1e3));
    }
    clearGcTimeout() {
  ...
  kt = class extends vt {
    ...
    setData(t, e) {
      const s = G(this.state.data, t, this.options);
      return (
        this.#u({ data: s, type: "success", dataUpdatedAt: e?.updatedAt, manual: e?.manual }),
        s
      );
    }
    setState(t, e) {
      this.#u({ type: "setState", state: t, setStateOptions: e });
    }
    cancel(t) {
    ...
    isActive() {
      return this.observers.some((t) => w(t.options.enabled, this) !== !1);
    }
    isDisabled() {
    ...
    isStatic() {
      return this.getObserversCount() > 0
        ? this.observers.some((t) => F(t.options.staleTime, this) === "static")
        : !1;
    }
    isStale() {
      return this.getObserversCount() > 0
    ...
    removeObserver(t) {
      this.observers.includes(t) &&
        ...
        this.observers.length ||
          (this.#i &&
            (this.#a || this.#o() ? this.#i.cancel({ revert: !0 }) : this.#i.cancelRetry()),
          this.scheduleGc()),
    ...
    async fetch(t, e) {
      ...
      const s = new AbortController(),
        ...
        r = () => {
          ...
          return (
            (this.#a = !1),
            this.options.persister ? this.options.persister(n, l, this) : n(l)
          );
        },
        o = (() => {
          const n = {
      ...
      (this.options.behavior?.onFetch(o, this),
        ...
        (this.#i = yt({
          ...
          fn: o.fetchFn,
          onCancel: (n) => {
            (n instanceof z && n.revert && this.setState({ ...this.#e, fetchStatus: "idle" }),
              s.abort());
          },
          onFail: (n, h) => {
            this.#u({ type: "failed", failureCount: n, error: h });
          },
          onPause: () => {
            this.#u({ type: "pause" });
          },
      ...
      try {
        ...
        if (n instanceof z) {
          if (n.silent) return this.#i.promise;
          if (n.revert) {
    ...
    #u(t) {
      const e = (s) => {
        switch (t.type) {
          ...
          case "fetch":
            return { ...s, ...mt(s.data, this.options), fetchMeta: t.meta ?? null };
          case "success":
            const i = {
              ...s,
...
function mt(t, e) {
  return {
    fetchFailureCount: 0,
    fetchFailureReason: null,
    fetchStatus: pt(e.networkMode) ? "fetching" : "paused",
...
var Kt = class extends I {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      at(this.#e, this.options) ? this.#f() : this.updateResult(),
      this.#b());
  }
  onUnsubscribe() {
  ...
  shouldFetchOnReconnect() {
    return W(this.#e, this.options, this.options.refetchOnReconnect);
  }
  shouldFetchOnWindowFocus() {
    return W(this.#e, this.options, this.options.refetchOnWindowFocus);
  }
  destroy() {
    ((this.listeners = new Set()), this.#O(), this.#S(), this.#e.removeObserver(this));
  }
  setOptions(t) {
    ...
    if (
      ...
      this.options.enabled !== void 0 &&
        ...
        typeof w(this.options.enabled, this.#e) != "boolean")
    )
    ...
    (i && ot(this.#e, s, this.options, e) && this.#f(),
      this.updateResult(),
      i &&
        (this.#e !== s ||
          w(this.options.enabled, this.#e) !== w(e.enabled, this.#e) ||
          F(this.options.staleTime, this.#e) !== F(e.staleTime, this.#e)) &&
        this.#v());
    const r = this.#m();
    i &&
      (this.#e !== s ||
  ...
  getOptimisticResult(t) {
    ...
    return (_t(this, s) && ((this.#r = s), (this.#n = this.options), (this.#i = this.#e.state)), s);
  }
  getCurrentResult() {
    return this.#r;
  }
  ...
  #v() {
    this.#O();
    const t = F(this.options.staleTime, this.#e);
    if (A.isServer() || this.#r.isStale || !H(t)) return;
    const s = lt(this.#r.dataUpdatedAt, t) + 1;
    this.#c = Q.setTimeout(() => {
  ...
  #g(t) {
    (this.#S(),
      (this.#h = t),
      !(A.isServer() || w(this.options.enabled, this.#e) === !1 || !H(this.#h) || this.#h === 0) &&
        (this.#l = Q.setInterval(() => {
          (this.options.refetchIntervalInBackground || V.isFocused()) && this.#f();
        }, this.#h)));
  }
  #b() {
  ...
  #O() {
    this.#c && (Q.clearTimeout(this.#c), (this.#c = void 0));
  }
  #S() {
    this.#l && (Q.clearInterval(this.#l), (this.#l = void 0));
  }
  createResult(t, e) {
    const s = this.#e,
      i = this.options,
    ...
    if (e._optimisticResults) {
      const S = this.hasListeners(),
        D = !S && at(t, e),
        j = S && ot(t, s, e, i);
      ((D || j) && (u = { ...u, ...mt(l.data, t.options) }),
        e._optimisticResults === "isRestoring" && (u.fetchStatus = "idle"));
    }
    let { error: m, errorUpdatedAt: d, status: f } = u;
    c = u.data;
    let g = !1;
    if (e.placeholderData !== void 0 && c === void 0 && f === "pending") {
      let S;
      (r?.isPlaceholderData && e.placeholderData === o?.placeholderData
        ? ((S = r.data), (g = !0))
        : (S =
            typeof e.placeholderData == "function"
              ? e.placeholderData(this.#p?.state.data, this.#p)
              : e.placeholderData),
        S !== void 0 && ((f = "success"), (c = G(r?.data, S, e)), (v = !0)));
    }
    if (e.select && c !== void 0 && !g)
      if (r && c === a?.data && e.select === this.#u) c = this.#d;
      else
        try {
          ((this.#u = e.select),
            (c = e.select(c)),
    ...
    this.#o && ((m = this.#o), (c = this.#d), (d = Date.now()), (f = "error"));
    const O = u.fetchStatus === "fetching",
      C = f === "pending",
      P = f === "error",
      E = C && O,
      M = c !== void 0,
      R = {
        ...
        isFetchedAfterMount:
          u.dataUpdateCount > h.dataUpdateCount || u.errorUpdateCount > h.errorUpdateCount,
        isFetching: O,
        isRefetching: O && !C,
        isLoadingError: P && !M,
    ...
    if (this.options.experimental_prefetchInRender) {
      const S = R.data !== void 0,
        D = R.status === "error" && !S,
        j = (q) => {
          D ? q.reject(R.error) : S && q.resolve(R.data);
        },
        Y = () => {
          const q = (this.#a = R.promise = B());
          j(q);
        },
        U = this.#a;
      switch (U.status) {
  ...
  updateResult() {
    ...
    const s = () => {
      ...
      if (r === "all" || (!r && !this.#y.size)) return !0;
      const a = new Set(r ?? this.#y);
      return (
        this.options.throwOnError && a.add("error"),
        Object.keys(this.#r).some((o) => {
          const n = o;
...
function at(t, e) {
  return Lt(t, e) || (t.state.data !== void 0 && W(t, e, e.refetchOnMount));
}
function W(t, e, s) {
  if (w(e.enabled, t) !== !1 && F(e.staleTime, t) !== "static") {
    const i = typeof s == "function" ? s(t) : s;
    return i === "always" || (i !== !1 && X(t, e));
  }
  return !1;
}
function ot(t, e, s, i) {
  return (
    (t !== e || w(i.enabled, t) === !1) && (!s.suspense || t.state.status !== "error") && X(t, s)
  );
}
function X(t, e) {
  return w(e.enabled, t) !== !1 && t.isStaleByTime(F(e.staleTime, t));
}
function _t(t, e) {
  return !K(t.getCurrentResult(), e);
}
function ut(t) {
  return {
    onFetch: (e, s) => {
      ...
      const l = async () => {
        ...
        const v = (d) => {
          ...
          c = dt(e.options, e.fetchOptions),
          m = async (d, f, g) => {
            if (u) return Promise.reject();
            if (f == null && d.pages.length) return Promise.resolve(d);
            const C = (() => {
                const _ = {
                  client: e.client,
                  queryKey: e.queryKey,
              ...
              P = await c(C),
              { maxPages: E } = e.options,
              M = g ? Dt : It;
            return { pages: M(d.pages, P, E), pageParams: M(d.pageParams, f, E) };
          };
        if (r && a.length) {
          const d = r === "backward",
            f = d ? Ht : ht,
            g = { pages: a, pageParams: o },
            O = f(i, g);
          n = await m(g, O, d);
        } else {
          const d = t ?? a.length;
          do {
            const f = h === 0 ? (o[0] ?? i.initialPageParam) : ht(i, n);
            if (h > 0 && f == null) break;
            ((n = await m(n, f)), h++);
          } while (h < d);
        }
...
function ht(t, { pages: e, pageParams: s }) {
  const i = e.length - 1;
    ...
    try {
      if (i) e();
        ...
        o !== this.state.context &&
          this.#i({ type: "pending", context: o, variables: t, isPaused: r });
      }
      ...
      try {
        await this.#s.config.onError?.(a, t, this.state.context, this, s);
      } catch (o) {
        Promise.reject(o);
      }
      try {
        await this.options.onError?.(a, t, this.state.context, s);
      } catch (o) {
        Promise.reject(o);
      }
      try {
      ...
      try {
        await this.options.onSettled?.(void 0, a, t, this.state.context, s);
      } catch (o) {
        Promise.reject(o);
      }
...
var Gt = class extends I {
  ...
  resumePausedMutations() {
    ...
    return p.batch(() => Promise.all(t.map((e) => e.continue().catch(b))));
  }
};
function k(t) {
...
var Bt = class extends I {
    ...
    #n(t) {
      p.batch(() => {
        if (this.#r && this.hasListeners()) {
          ...
          if (t?.type === "success") {
            try {
              this.#r.onSuccess?.(t.data, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
            try {
              this.#r.onSettled?.(t.data, null, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
          } else if (t?.type === "error") {
            try {
              this.#r.onError?.(t.error, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
            try {
              this.#r.onSettled?.(void 0, t.error, e, s, i);
            } catch (r) {
              Promise.reject(r);
            }
          }
  ...
  zt = class extends I {
    ...
    find(t) {
      const e = { exact: !0, ...t };
      return this.getAll().find((s) => tt(e, s));
    }
    findAll(t = {}) {
      const e = this.getAll();
      return Object.keys(t).length > 0 ? e.filter((s) => tt(t, s)) : e;
    }
    notify(t) {
      p.batch(() => {
        this.listeners.forEach((e) => {
  ...
  ae = class {
    ...
    #o;
    constructor(t = {}) {
      ((this.#t = t.queryCache || new zt()),
        (this.#e = t.mutationCache || new Gt()),
    ...
    mount() {
      (this.#n++,
        this.#n === 1 &&
          ((this.#a = V.subscribe(async (t) => {
            t && (await this.resumePausedMutations(), this.#t.onFocus());
          })),
          (this.#o = L.subscribe(async (t) => {
            t && (await this.resumePausedMutations(), this.#t.onOnline());
          }))));
    }
    unmount() {
      (this.#n--,
        this.#n === 0 && (this.#a?.(), (this.#a = void 0), this.#o?.(), (this.#o = void 0)));
    }
    isFetching(t) {
    ...
    ensureQueryData(t) {
      ...
      return i === void 0
        ? this.fetchQuery(t)
        : (t.revalidateIfStale && s.isStaleByTime(F(e.staleTime, s)) && this.prefetchQuery(e),
          Promise.resolve(i));
    }
    getQueriesData(t) {
    ...
    setQueryData(t, e, s) {
      const i = this.defaultQueryOptions({ queryKey: t }),
        ...
        o = Mt(e, a);
      if (o !== void 0) return this.#t.build(this, i).setData(o, { ...s, manual: !0 });
    }
    setQueriesData(t, e, s) {
      return p.batch(() =>
        this.#t.findAll(t).map(({ queryKey: i }) => [i, this.setQueryData(i, e, s)]),
      );
    }
    getQueryState(t) {
      const e = this.defaultQueryOptions({ queryKey: t });
    ...
    cancelQueries(t, e = {}) {
      const s = { revert: !0, ...e },
        i = p.batch(() => this.#t.findAll(t).map((r) => r.cancel(s)));
    ...
    setQueryDefaults(t, e) {
      this.#r.set(T(t), { queryKey: t, defaultOptions: e });
    }
    getQueryDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          x(t, i.queryKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
    setMutationDefaults(t, e) {
      this.#i.set(T(t), { mutationKey: t, defaultOptions: e });
    }
    getMutationDefaults(t) {
      ...
      return (
        e.forEach((i) => {
          x(t, i.mutationKey) && Object.assign(s, i.defaultOptions);
        }),
        s
      );
    }
    defaultQueryOptions(t) {
      ...
      return (
        e.queryHash || (e.queryHash = $(e.queryKey, e)),
  ...
  oe = ({ client: t, children: e }) => (
    ...
    wt.jsx(bt.Provider, { value: t, children: e })
  ),
  St = y.createContext(!1),
  Wt = () => y.useContext(St);
St.Provider;
function Vt() {
  let t = !1;
...
var $t = y.createContext(Vt()),
  Jt = () => y.useContext($t),
  Zt = (t, e, s) => {
    const i =
      s?.state.error && typeof t.throwOnError == "function"
        ? Z(t.throwOnError, [s.state.error, s])
        : t.throwOnError;
  ...
  Yt = ({ result: t, errorResetBoundary: e, throwOnError: s, query: i, suspense: r }) =>
    t.isError &&
    !e.isReset() &&
    !t.isFetching &&
    i &&
    ((r && t.data === void 0) || Z(s, [t.error, i])),
  te = (t) => {
    if (t.suspense) {
      const s = (r) => (r === "static" ? r : Math.max(r ?? 1e3, 1e3)),
        i = t.staleTime;
      ((t.staleTime = typeof i == "function" ? (...r) => s(i(...r)) : s(i)),
        typeof t.gcTime == "number" && (t.gcTime = Math.max(t.gcTime, 1e3)));
    }
  },
  ee = (t, e) => t.isLoading && t.isFetching && !e,
  se = (t, e) => t?.suspense && e.isPending,
  ct = (t, e, s) =>
...
function ie(t, e, s) {
  ...
  ((o._optimisticResults = i ? "isRestoring" : "optimistic"), te(o), Zt(o, r, n), Xt(r));
  const h = !a.getQueryCache().get(o.queryHash),
    [l] = y.useState(() => new e(a, o)),
  ...
  if (
    (y.useSyncExternalStore(
      y.useCallback(
        (c) => {
          const m = v ? l.subscribe(p.batchCalls(c)) : b;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !A.isServer() &&
      ee(u, i) &&
      (h ? ct(o, l, r) : n?.promise)?.catch(b).finally(() => {
        l.updateResult();
      }),
...
function he(t, e) {
  const s = Ot(),
    [i] = y.useState(() => new Bt(s, t));
  y.useEffect(() => {
    i.setOptions(t);
  }, [i, t]);
  const r = y.useSyncExternalStore(
      y.useCallback((o) => i.subscribe(p.batchCalls(o)), [i]),
      () => i.getCurrentResult(),
      () => i.getCurrentResult(),
    ),
    a = y.useCallback(
  ...
  if (r.error && Z(i.options.throwOnError, [r.error])) throw r.error;
  return { ...r, mutate: a, mutateAsync: r.mutate };
}
export { oe as Q, Ot as a, he as b, ae as c, ne as k, ue as u };
